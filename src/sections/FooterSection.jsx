          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1A1A1A] rounded-3xl p-8 border border-white/5">
              ...
              <div className="space-y-4">
                <a href="mailto:ashitoshlavhate2@gmail.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
                  <Mail className="w-5 h-5" />
                  ashitoshlavhate2@gmail.com
                </a>
                <a href="tel:+919518352166" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
